...
pv_spec = client.V1PersistentVolumeSpec(capacity={'storage': '10Gi'}, access_modes=['ReadWriteOnce'], host_path=hpvs)
vol_resource = client.V1VolumeResourceRequirements(requests={'storage': '3Gi'})
pvc_spec = client.V1PersistentVolumeClaimSpec(storage_class_name='default', access_modes=['ReadWriteOnce'], resources=vol_resource)
