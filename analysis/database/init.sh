...
export CLICKHOUSE_ENDPOINT="http://$RELEASE_NAME.$NAMESPACE.svc.cluster.local:8123"
...
echo "export CLICKHOUSE_ENDPOINT=\"http://$RELEASE_NAME.$NAMESPACE.svc.cluster.local:8123\""
echo ""
