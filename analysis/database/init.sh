...
export CLICKHOUSE_ENDPOINT="http://$RELEASE_NAME.$NAMESPACE.svc.cluster.local:9000"
...
echo "export CLICKHOUSE_ENDPOINT=\"http://$RELEASE_NAME.$NAMESPACE.svc.cluster.local:9000\""
echo ""
